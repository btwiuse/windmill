...
use crate::{
    ...
    AuthedClientBackgroundTask, ConnectionMode, DISABLE_NSJAIL, DISABLE_NUSER, HOME_ENV,
    INSTANCE_PYTHON_VERSION, NSJAIL_PATH, PATH_ENV, PIP_EXTRA_INDEX_URL, PIP_INDEX_URL, PROXY_ENVS,
    PY_INSTALL_DIR, TZ_ENV, UV_CACHE_DIR,
};
...
impl PyVersion {
    pub async fn from_instance_version(job_id: &Uuid, w_id: &str, db: &ConnectionMode) -> Self {
        let mut err = None;
